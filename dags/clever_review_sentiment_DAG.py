...
from scripts.review_sentiment_analysis import sentiment_analysis
...
with DAG("clever_review_sentiment_DAG", default_args=default_args, catchup=False, schedule_interval='20 0 * * *', max_active_runs=1) as dag:
